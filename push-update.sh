...
if [ ! -f "$1" ]; then
   ...
   echo
   echo "The name of ZIP is assumed to have PixelDust-VERSION-DATE-TYPE-* as format"
...
# Assume PixelDustAndroid-VERSION-DATE-TYPE-*.zip
...
adb shell "killall com.pixeldust.updater 2>/dev/null"
adb shell "sqlite3 /data/data/com.pixeldust.updater/databases/updates.db" \
